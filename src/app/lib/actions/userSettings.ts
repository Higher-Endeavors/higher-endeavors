...
export async function getUserSettings(): Promise<UserSettings | null> {
  ...
  return {
    general: {
      ...
      notifications_email: db.notifications_email,
      notifications_text: db.notifications_text,
      notifications_app: db.notifications_app,
    },
...
export async function updateUserSettings(data: Partial<UserSettings>): Promise<UserSettings> {
  ...
  const merged = { ...{
    general: {
      ...
      notifications_text: current.notifications_text,
      notifications_app: current.notifications_app,
    },
  ...
  const values = [
    ...
    g.dateFormat,
    g.language,
    g.notifications_email,
    g.notifications_text,
    g.notifications_app,
