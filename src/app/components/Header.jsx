    ...
    <header className="px-20 py-4 flex flex-col md:flex-row sm:flex-row justify-between">
      <div>
       ...
       <div className="space-x-8 flex pt-3"> 
        <a href="">
          <svg className="w-[40px] h-[40px] text-gray-800 dark:text-white hover:text-[#CBAACB]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <a href="https://www.facebook.com/higherendeavors" target="_blank">
          <svg className="w-[40px] h-[40px] text-gray-800 dark:text-white hover:text-[#CBAACB]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
