...
// Dependencies
import { FaUserCircle, FaSignOutAlt, FaTasks, FaEnvelope, FaBook, FaProjectDiagram, FaChevronDown, FaChevronLeft, FaCog, FaIdBadge, FaChevronRight, FaHeartbeat, FaAppleAlt, FaTachometerAlt, FaListUl, FaUtensils } from 'react-icons/fa';
...
export default function UserSidebar() {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`z-30 fixed md:static left-0 top-0 h-screen transition-all duration-200 bg-white dark:bg-[#232221] shadow-lg flex flex-col ${expanded ? 'w-60' : 'w-16'} border-r border-slate-200 dark:border-slate-800`}
