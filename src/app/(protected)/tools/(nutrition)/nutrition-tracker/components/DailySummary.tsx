...
export default function DailySummary() {
  ...
  const placeholderDailySummary = {
    total_water: '80 ounces',
    total_calories: '2400 calories',
    total_carbohydrates: '200 grams',
    total_protein: '100 grams',
    total_fat: '100 grams',
  };
  ...
  return (
    <div className="bg-gray-100 dark:bg-[#e0e0e0] rounded-lg shadow p-6 mb-4">
      <div className="flex justify-between items-center cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-900">Daily Summary</h2>
        <button
      ...
      {isOpen && (
        <div className="mt-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {Object.entries(placeholderDailySummary).map(([key, value]) => (
