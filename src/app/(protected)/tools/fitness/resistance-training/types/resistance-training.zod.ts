...
export const ResistanceProgramSchema = z.object({
  ...
  resistPhaseId: z.number().int().nullable().optional(),
  resistPhaseName: z.string().optional(),
  resistPeriodizationId: z.number().int().nullable().optional(),
  resistPeriodizationName: z.string().optional(),
